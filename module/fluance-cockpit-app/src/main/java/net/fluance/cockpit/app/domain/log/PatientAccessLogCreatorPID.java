...
public class PatientAccessLogCreatorPID extends LogCreator {
	...
	public LogModel getLogModel() {
		super.init();
		Patient p = (Patient) patientService.patientDetail(Long.valueOf(params.getMap().get(PatientAccessLogService.PID_KEY)[0]));
	...
	public PatientAccessLogCreatorPID(MwAppResourceType resourceType, Object payload, Map<String, String[]> params, User user, String httpMethod, String uri) {
